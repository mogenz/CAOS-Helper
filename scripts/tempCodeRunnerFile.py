...
def main():
    ...
    expressions = [input(f"Enter expression for Q{i+1} (e.g., A AND (NOT B) AND C): ").strip() for i in range(num_expressions)]
    expressions.append(input("Enter expression for Q (e.g., Q1 OR Q2 OR Q3 OR Q4): ").strip())
